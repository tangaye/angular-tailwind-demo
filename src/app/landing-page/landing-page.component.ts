    ...
    stakeholders = [
        {
            ...
            description: "Student teams can review feedback from faculty and advisors who view presentations. Students can also provide comments and feedback to other teams as part of the process, and can login using their google email account.<br><br>If you are student judging a session, after you login you may see a bar just below the menu toolbar to select the name of the session. Your faculty member will give you a session wide student judging password to let you in. You will be able to identify your team during this process.<br><br>Student team members can build out their own team page, with relevant links and information for judges on their own Team page."
        },
        {
            name: "Faculty",
